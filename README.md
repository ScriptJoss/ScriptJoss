...
- **Ciberseguridad**: 🔒 Me apasiona proteger los datos y mantener la seguridad en la red.
- **Desarrollo Full Stack**: 🌐 Aspiro a crear aplicaciones completas, desde el frontend hasta el backend, para ofrecer soluciones integrales y funcionales.

## Conocimientos Técnicos 💻

- **C++**: Lenguaje de alto rendimiento para crear aplicaciones eficientes.
- **Python**: Ideal para desarrollo web, automatización y ciberseguridad.
- **JavaScript**: Para agregar interactividad y dinamismo a las aplicaciones web.
- **HTML & CSS**: Para estructurar y diseñar sitios web atractivos.
...
## 💫 Sobre mí:
- 🔗 **Aprendiendo:** Backend con **Python**, **NodeJS**, **TypeScript**, **React**, **VueJS**, **Django** y **Flask**.
- 💬 **Pregúntame sobre:** **C++**, **Python**, **JavaScript**, **HTML**, **CSS**.
- 📧 **Contáctame:** **josselfdev@gmail.com**<br>
